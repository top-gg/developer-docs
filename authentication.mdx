...
<Steps>
  <Step title="Open your bot's dashboard">
    Navigate to your bot's page on Top.gg and open the dashboard. For v0, go directly to:
    ```
    https://top.gg/bot/:yourbotid/dashboard/integrations
    ```
