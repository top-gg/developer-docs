...
Access tokens work with the same v1 API as project tokens, with a project ID in the path instead of `@me`:

| Project token | OAuth access token |
| --- | --- |
| `GET /projects/@me` | `GET /projects/:project_id` |
| `GET /projects/@me/votes` | `GET /projects/:project_id/votes` |
| `PATCH /projects/@me/metrics` | `PATCH /projects/:project_id/metrics` |
