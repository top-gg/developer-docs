...
- Build applications that users authorize with OAuth to manage their projects for them
...
<CardGroup cols={2}>
  ...
  <Card title="OAuth" icon="user-check" href="/oauth/overview">
    Let users authorize your application to act on their projects.
  </Card>
</CardGroup>
